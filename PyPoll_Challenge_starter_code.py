...
file_to_load = os.path.join("Module_3","election_results.csv")
...
with open(file_to_save, "w") as txt_file:
    ...
    largest_county_summary = (
        f"-------------------------\n"
        f"County with the largest turnout: {largest_county_votes}\n"
        f"Total Voter Turnout: {total_voter_turnout:,}\n"
        f"-------------------------\n")
